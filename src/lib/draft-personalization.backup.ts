...
function buildOfferLine(roleDetail: string | null, helpAreas: string) {
  if (roleDetail) {
    return `From what I could tell on your site, ${roleFocusPhrase(roleDetail)} seem to matter a lot to the team, which is why I thought I could help with ${helpAreas}.`;
  }

  return `Because of that, I thought I could probably be useful with ${helpAreas}.`;
}
